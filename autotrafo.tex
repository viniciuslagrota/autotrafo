...
%						\ly+2.8) --++(1.5,0) node[black, above, pos=0.4] {\Huge $I_A$};
%						
%						
%						\draw[-latex] (-\lx, \ly+0.2) --++ (0, 2.4) node[midway, left] {\Huge $V_A$};
%									
...
%		%				(\a+3*\lx-0.2, \ly+3.1) --++(\a/2, 0) node[black, midway, above] {\Huge $I_B$};
%		
%		
%						\draw [rounded corners=2pt, red, thick, postaction={decorate}]
%						(7.3, 4.1) --++ (-1.5, 0) node[black, midway, above] {\Huge $I_B$};
%						
%						
%						
%						
...
%							0.06);
%						}
%						\draw[-latex] (2*\a+\lx, \ly+0.2) --++(0, 2.7) node[midway, right] {\Huge $V_B$};
%						
%						%end
...
%						(1, 0.5) --++ (1, 0) node[black, right] {\Huge $\textcolor{blue}{\phI_A}$};
%						
%						\draw [-latex, rounded corners=2pt, red, thick]
%						(4, 4.5) --++ (-1, 0) node[black, left] {\Huge $\textcolor{red}{\phI_B}$};
%					\end{scope}
%				\end{circuitikz}
%			\end{center}
%		}
...
%			\begin{block}{Conceito}
%				\begin{itemize}
%					\item Os fluxos produzidos ($\phI_A$ e $\phI_B$) estão ambos no sentido anti-horário $\Rightarrow$ acoplamento mútuo tende a aumentar a aumentar a intensidade das tensões induzidas. 
%%					\item Os fluxos magnéticos são completamente compreendidos definidos pelas correntes $I_A$ e $I_B$ variáveis no tempo.
%				\end{itemize}
%			\end{block}
%		}
%%		\only<3>
...
%%					\left\{ \begin{array}{l}
%%					\frac{{\partial {\phi _1}}}{{\partial {I_A}}}d{I_A} + \frac{{\partial {\phi _1}}}{{\partial {I_B}}}d{I_B} = d{\phi _1}\\[5pt]
%%					\frac{{\partial {\phi _2}}}{{\partial {I_A}}}d{I_A} + \frac{{\partial {\phi _2}}}{{\partial {I_B}}}d{I_B} = d{\phi _2}
%%					\end{array} \right.
%%				\end{equation}
%%				\begin{equation}\label{key}
%%				\left\{ \begin{array}{l}
%%				\left( {{N_{SE}}\frac{{\partial {\phi _1}}}{{\partial {I_A}}}} \right)\frac{{d{I_A}}}{{dt}} + \left( {{N_{SE}}\frac{{\partial {\phi _1}}}{{\partial {I_B}}}} \right)\frac{{d{I_B}}}{{dt}} = {N_{SE}}\frac{{d{\phi _1}}}{{dt}}\\[5pt]
%%				\left( {{N_C}\frac{{\partial {\phi _2}}}{{\partial {I_A}}}} \right)\frac{{d{I_A}}}{{dt}} + \left( {{N_C}\frac{{\partial {\phi _2}}}{{\partial {I_B}}}} \right)\frac{{d{I_B}}}{{dt}} = {N_C}\frac{{d{\phi _2}}}{{dt}}
%%				\end{array} \right.
%%				\end{equation}
%%			\end{block}
%%		}
...
%%				\left\{ \begin{array}{l}
%%				{L_1}\frac{{d{I_A}}}{{dt}} + M\frac{{d{I_B}}}{{dt}} = {V_A}\\[5pt]
%%				M\frac{{d{I_A}}}{{dt}} + {L_2}\frac{{d{I_B}}}{{dt}} = {V_B}
%%				\end{array} \right.
%%				\end{equation}
%%			\end{block}
%%		}
...
%				M = {N_{SE}}\frac{{\partial {\phi _1}}}{{\partial {I_B}}} = {N_C}\frac{{\partial {\phi _2}}}{{\partial {I_A}}}
%				\end{equation}
%			\end{block}
%		}
%	\end{overprint}
...
%					}
%					\draw [rounded corners=2pt,blue, thick, postaction={decorate}] (-1.5,
%					\ly+2.8) --++(1.5,0) node[black, above, pos=0.1] {\Huge $I_A$};
%					
%					
%					\draw[-latex] (-\lx, \ly+0.2) --++ (0, 2.4) node[midway, left] {\Huge $V_A$};
%					
...
%					
%					\draw [rounded corners=2pt, red, thick, postaction={decorate}]
%					(7.3, 4.1) --++ (-1.5, 0) node[black, midway, above, pos=0.1] {\Huge $I_B$};
%					
%					
%					
%					
...
%					\draw (A) to[open, v=$V_A$] (B);
%					% Secondary
%					\draw (1.5,0) -- (1,0);
%					\draw (1.5,-2.1) -- (1,-2.1);
%					\draw node[circ] (C) at (1.5,0) {};
%					\draw node[circ] (D) at (1.5,-2.1) {};
%					\draw (C) to[open, v^=$V_B$] (D);
%					% Current i1
%					\draw [-latex] (-1.25,0.25) --++ (0.75,0) node[midway, above] {$I_A$};
%					% Current i2
%					\draw [-latex] (1.25,0.25) --++ (-0.75,0) node[midway, above] {$I_B$};
%					% L1
...
%				\left\{ \begin{array}{l}
%				j\omega{L_1}{I_A} - j\omega M{I_B} = {V_A}\\
%				{Z_2}{I_B} + j\omega{L_2}{I_B} - j\omega M{I_A} = 0
%				\end{array} \right.
%				\end{equation}
%			\end{block}
%		}
...
%				\left\{ \begin{array}{l}
%				\frac{{{V_B}}}{{{V_A}}} = \frac{{{N_C}}}{{{N_{SE}}}} = N\\
%				\frac{{{I_B}}}{{{I_A}}} = \frac{{{N_{SE}}}}{{{N_C}}} = \frac{1}{N}\\
%				\frac{{{Z_2}}}{{{Z_1}}} = {\left( {\frac{{{N_C}}}{{{N_{SE}}}}} \right)^2} = {N^2}
%				\end{array} \right.
%				\end{equation}
%			\end{minipage}
%			\hfill
...
\framesubtitle{Configuração elevadora}
	...
	\begin{circuitikz}[scale=0.8, every node/.style={scale=0.8}]
		...
		\draw node[circ] at (0.35, 1) {};
		% Arrow
		\draw [latex-latex] (0.5,2.3) to [out=-60,in=60] (0.5,1);
...
%				\begin{equation}\label{key} \tag{8}
%				\left\{ \begin{array}{l}
%				{L_1}\frac{{d{I_A}}}{{dt}} + M\left( {\frac{{d{I_A}}}{{dt}} - \frac{{d{I_B}}}{{dt}}} \right) + {L_2}\left( {\frac{{d{I_A}}}{{dt}} - \frac{{d{I_B}}}{{dt}}} \right) + M\frac{{d{I_A}}}{{dt}} = {V_A}\\[5pt]
%				R{I_B} + {L_2}\left( {\frac{{d{I_B}}}{{dt}} - \frac{{d{I_A}}}{{dt}}} \right) - M\frac{{d{I_A}}}{{dt}} = 0
%				\end{array} \right.
%				\end{equation}
%				Rearranjando,
%				\vspace{-0.4cm}
%				\begin{equation}\label{key} \tag{9}
%				\left\{ \begin{array}{l}
%				\left( {{L_1} + {L_2} + 2M} \right)\frac{{d{I_A}}}{{dt}} - \left( {{L_2} + M} \right)\frac{{d{I_B}}}{{dt}} = {V_A}\\[5pt]
%				- \left( {{L_2} + M} \right)\frac{{d{I_A}}}{{dt}} + {L_2}\frac{{d{I_B}}}{{dt}} + R{I_B} = 0
%				\end{array} \right.
%				\end{equation}
%			\end{block}
%		}
...
%				\end{array} \right.
%				\end{equation}
%				Isolando $\frac{dI_A}{dt}$ na segunda equação em (9):
%				\vspace{-0.3cm}
%				\begin{equation}\label{key} \tag{10}
%				\left\{ \begin{array}{l}
%				\left( {{L_1} + {L_2} + 2M} \right)\frac{{d{I_A}}}{{dt}} - \left( {{L_2} + M} \right)\frac{{d{I_B}}}{{dt}} = {V_A}\\[5pt]
%				\frac{{d{I_A}}}{{dt}} = \frac{{{L_2}\frac{{d{I_B}}}{{dt}} + R{I_B}}}{{\left( {{L_2} + M} \right)}}
%				\end{array} \right.
%				\end{equation}
%			\end{block}
%		}
...
%				\vspace{-0.3cm}
%				\begin{equation}\label{key} \tag{11}
%				\left( {\frac{{{L_1} + {L_2} + 2M}}{{{L_2} + M}}} \right)\left( {{L_2}\frac{{d{I_B}}}{{dt}} + R{I_B}} \right) - \left( {{L_2} + M} \right)\frac{{d{I_B}}}{{dt}} = {V_A}
%				\end{equation}
%			\end{block}
%		}
%		\only<5>
...
%				\vspace{-0.3cm}
%				\begin{equation}\label{key} \tag{12}
%				\left( {{L_1}{L_2} - {M^2}} \right)\frac{{d{I_B}}}{{dt}} + R\left( {{L_1} + {L_2} + 2M} \right){I_B} = \left( {{L_2} + M} \right){V_A}
%				\end{equation}
%			\end{block}
%		}
%		\only<6>
...
%				\vspace{-0.3cm}
%				\begin{equation}\label{key} \tag{13}
%				\textcolor{red}{\left( {{L_1}{L_2} - {M^2}} \right)\frac{{d{I_B}}}{{dt}}} + R\left( {{L_1} + {L_2} + 2M} \right){I_B} = \left( {{L_2} + M} \right){V_A}
%				\end{equation}
%			\end{block}
%		}
%		\only<7>
...
%				\vspace{-0.3cm}
%				\begin{equation}\label{key} \tag{13}
%				R\left( {{L_1} + {L_2} + 2M} \right){I_B} = \left( {{L_2} + M} \right){V_A}
%				\end{equation}
%			\end{block}
%		}
%		\only<8>
...
%				Portanto,
%				\begin{equation}\label{key} \tag{14}
%				{I_B} = \frac{{\left( {{L_2} + M} \right)}}{{R\left( {{L_1} + {L_2} + 2M} \right)}}{V_A}
%				\end{equation}
%			\end{block}
%		}
%		\only<9>
...
%%				\vspace{-0.3cm}
%				\begin{equation}\label{key} \tag{15}
%				j\omega \left( {{L_1}{L_2} - {M^2}} \right){I_B} + R\left( {{L_1} + {L_2} + 2M} \right){I_B} = \left( {{L_2} + M} \right){V_A}
%				\end{equation}
%			\end{block}
%		}
%		\only<10>
...
%				\frac{{{I_B}}}{{{V_A}}} = \frac{{{L_2} + M}}{{j\omega \left( {{L_1}{L_2} - {M^2}} \right) + R\left( {{L_1} + {L_2} + 2M} \right)}}
%				\end{equation}
%			\end{block}
%		}
%		\only<11>
...
%				- j\omega \left( {{L_2} + M} \right){I_A} + j\omega {L_2}{I_B} + R{I_B} = 0 \Rightarrow \frac{{{I_B}}}{{{I_A}}} = \frac{{j\omega \left( {{L_2} + M} \right)}}{{j\omega {L_2} + R}}
%				\end{equation}
%			\end{block}
%		}
%		\only<12>
...
%				\frac{{{I_B}}}{{{I_A}}} = \frac{{j\omega \left( {{L_2} + M} \right)}}{{j\omega {L_2}}} = 1 + \frac{M}{{{L_2}}} = 1 + \frac{{k\sqrt {{L_1}{L_2}} }}{{{L_2}}} = 1 + \sqrt {\frac{{{L_1}}}{{{L_2}}}}  = 1 + \frac{{{N_{SE}}}}{{{N_C}}}
%				\end{equation}
%			\end{block}
%		}
%		\only<13>
...
%				\frac{{{V_B}}}{{{V_A}}} = \frac{{R{I_B}}}{{{V_A}}} = \frac{{R\left( {{L_2} + M} \right)}}{{j\omega \left( {{L_1}{L_2} - {M^2}} \right) + R\left( {{L_1} + {L_2} + 2M} \right)}}
%				\end{equation}
%			\end{block}
%		}
%		\only<15>
...
%				\frac{{{V_B}}}{{{V_A}}} = \frac{{R\left( {{L_2} + M} \right)}}{{R\left( {{L_1} + {L_2} + 2M} \right)}} = \frac{{{L_2} + M}}{{{L_1} + {L_2} + 2M}} = ... = \frac{{{N_C}}}{{{N_{SE}} + {N_C}}}
%				\end{equation}
%			\end{block}
%		}
%%		\only<16>
...
%%				%				\vspace{-0.3cm}
%%				\begin{equation}\label{key} \tag{20}
%%				\frac{{{V_B}}}{{{V_A}}} = \frac{{{L_2}\left( {1 + \frac{M}{{{L_2}}}} \right)}}{{{L_2}\left( {\frac{{{L_1}}}{{{L_2}}} + 1 + \frac{{2M}}{{{L_2}}}} \right)}} = \frac{{{L_2}\left( {1 + \frac{{\sqrt {{L_1}{L_2}} }}{{{L_2}}}} \right)}}{{{L_2}\left( {\frac{{{L_1}}}{{{L_2}}} + 1 + \frac{{2\sqrt {{L_1}{L_2}} }}{{{L_2}}}} \right)}}
%%				\end{equation}
%%			\end{block}
%%		}
%%		\only<17>
...
%%				%				\vspace{-0.3cm}
%%				\begin{equation}\label{key} \tag{20}
%%				\frac{{{V_B}}}{{{V_A}}} = \frac{{{L_2}\left( {1 + \frac{{\sqrt {{L_1}{L_2}} }}{{{L_2}}}} \right)}}{{{L_2}\left( {\frac{{{L_1}}}{{{L_2}}} + 1 + \frac{{2\sqrt {{L_1}{L_2}} }}{{{L_2}}}} \right)}} = \frac{{{L_2}\left( {1 + \sqrt {\frac{{{L_1}}}{{{L_2}}}} } \right)}}{{{L_2}\left( {\frac{{{L_1}}}{{{L_2}}} + 1 + 2\sqrt {\frac{{{L_1}}}{{{L_2}}}} } \right)}}
%%				\end{equation}
%%			\end{block}
%%		}
%%		\only<18>
...
%%				%				\vspace{-0.3cm}
%%				\begin{equation}\label{key} \tag{20}
%%				\frac{{{V_B}}}{{{V_A}}} = \frac{{{L_2}\left( {1 + \frac{{\sqrt {{L_1}{L_2}} }}{{{L_2}}}} \right)}}{{{L_2}\left( {\frac{{{L_1}}}{{{L_2}}} + 1 + \frac{{2\sqrt {{L_1}{L_2}} }}{{{L_2}}}} \right)}} = \frac{{{L_2}\left( {1 + \sqrt {\frac{{{L_1}}}{{{L_2}}}} } \right)}}{{{L_2}{{\left( {1 + \sqrt {\frac{{{L_1}}}{{{L_2}}}} } \right)}^2}}} = \frac{1}{{1 + \sqrt {\frac{{{L_1}}}{{{L_2}}}} }}
%%				\end{equation}
%%			\end{block}
%%		}
%%		\only<19>
...
%%				%				\vspace{-0.3cm}
%%				\begin{equation}\label{key} \tag{20}
%%				\frac{{{V_B}}}{{{V_A}}} = \frac{1}{{1 + \sqrt {\frac{{{L_1}}}{{{L_2}}}} }} = \frac{1}{{1 + \frac{{{N_{SE}}}}{{{N_C}}}}} = \frac{{{N_C}}}{{{N_{SE}} + {N_C}}}
%%				\end{equation}
%%			\end{block}
%%		}
%		\only<16>
...
%					\frac{{{V_A}}}{{{I_A}}} = \frac{{\frac{{{N_{SE}} + {N_C}}}{{{N_C}}}{V_B}}}{{\frac{{{N_C}}}{{{N_{SE}} + {N_C}}}{I_B}}} = {\left( {\frac{{{N_{SE}} + {N_C}}}{{{N_C}}}} \right)^2}\frac{{{V_B}}}{{{I_B}}} = {\left( {\frac{{{N_{SE}} + {N_C}}}{{{N_C}}}} \right)^2}R
%				\end{equation}
%			\end{block}
%		}
%		\only<18>
...
%				\end{minipage}
%				\begin{equation}\label{key} \tag{21}					
%				\frac{{{V_A}}}{{{I_A}}} = {\left( {\frac{{{N_{SE}} + {N_C}}}{{{N_C}}}} \right)^2}R
%				\end{equation}
%			\end{block}
%		}
%	\end{overprint}
